  ...
  return (
    <div className="bg-bgLightBlue rounded-xl p-[20px]">
      ...
      <div className="col-span-3">
        <div className=" mb-[20px] grid grid-cols-4 gap-[20px]">
          ...
          <div className="bg-darkerBlue rounded-xl col-span-3 flex flex-col justify-between p-[20px]">
          ...
          <div className="h-[400px] bg-darkerBlue rounded-xl p-[20px] flex flex-col justify-between col-span-3">
          ...
          <div className="bg-darkerBlue rounded-xl p-[30px]">
            ...
            <p className="text-[90px] text-red">
              <CountUp
                start={0.0}
                end={3.6}
          ...
          <div className="grid col-span-1 gap-[20px]">
          ...
          <div className="col-span-4 grid grid-cols-4 gap-[20px]">
            <div className="bg-darkerBlue rounded-xl p-[20px] col-span-4">
              ...
              <div className="grid grid-cols-5 overflow-auto gap-[20px]">
